        ...
        >
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-lg max-w-xl mx-auto" style={{ color: "rgba(255,255,255,0.65)" }}>
              Our hiring and technology partnerships ensure that what you learn
              at Next Minds is exactly what Nepal&apos;s top companies need.
            </p>
          </div>
        </section>
          ...
          <div className="max-w-2xl mx-auto">
            ...
            >
              ...
              <p className="mb-6" style={{ color: "rgba(255,255,255,0.65)" }}>
                Whether you&apos;re a company looking to hire trained talent or a
                technology brand that wants curriculum presence — let&apos;s talk.
              </p>
