...
export function CourseForm({ initial, categories, onSuccess }: CourseFormProps) {
    ...
    <form onSubmit={handleSubmit} className="space-y-4 max-h-[70vh] overflow-y-auto pr-1">
      ...
      <div className="space-y-1.5">
        <label className={labelClass} htmlFor="shortDesc">
          Short description <span className="font-normal text-gray-500">(shown on the course card)</span>
        </label>
        <textarea
          id="shortDesc"
          rows={2}
      ...
      <div className="space-y-2">
        <div className="flex items-center justify-between">
          ...
          <button
            type="button"
            onClick={() =>
              setCurriculum((mods) => [...mods, { title: "", topics: [] }])
            }
      ...
      <div className="space-y-2">
        ...
        {faqs.length === 0 && (
          <p className="rounded-xl bg-gray-50 px-4 py-3 text-sm text-gray-500">No FAQs yet.</p>
        )}
      ...
      <div className="space-y-1.5">
        ...
        <p className="text-xs text-gray-500">
          Saved as Markdown to <code className="text-gray-600">contentMd</code>.
        </p>
      </div>
